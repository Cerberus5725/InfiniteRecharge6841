...
ballIntakeButton = new JoystickButton(xBox, 5);
ballIntakeButton.whileHeld(new BallIntakeCode());
ballShooterButton = new JoystickButton(xBox, 6);
ballShooterButton.whileHeld(new BallShooterCode());
...
inverseDriveTrain.whenPressed(new InverseDriveTrainCode());
        ...
        SmartDashboard.putData("VisionTrackingCode", new VisionTrackingCode());
        SmartDashboard.putData("BallShooterCode", new BallShooterCode());
        SmartDashboard.putData("BallIntakeCode", new BallIntakeCode());
